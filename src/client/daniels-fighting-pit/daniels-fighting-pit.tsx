...
export class DanielsFightingPit {
  ...
  game: Game;
	...
	fighters: Fighter[] = [
    new Fighter('Daniel', {x:20, y:180}),
    new Fighter('Angelo', ({x:220, y:220})),
    new Fighter('Tomasz', {x:480, y:380}),
    new Fighter('Hassan', {x:180, y:120}),
    new Fighter('Alex', {x:120, y:380}),
    new Fighter('Paul', ({x:420, y:220})),
    new Fighter('Suluman', ({x:320, y:220})),
    new Fighter('Mark', {x:380, y:280}),
